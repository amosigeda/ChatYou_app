...
public class SendSMSUtil {
	...
	public static String username = "27006162_1";

	// 请登录zz.253.com 获取创蓝API密码(非登录密码)
	public static String password = "vbixjcak";
	...
	public static boolean sendSms(String phone, String smsCode) {
		...
		try {
			...
			String content = java.net.URLEncoder.encode(
					"【巧遇】您的登陆验证码为code，请在5分钟内登陆。如果不是您本人操作，请忽略本信息。".replaceAll("code", String.valueOf(smsCode)), "utf-8");
			String isLongSms = "0";
			String extenno = "";
	...
	public static boolean sendInternationalSms(String phone_num, String code) {
		String MemberID = "lailaitalk";
		String Password = "87736339";

//		if(!phone_num.subSequence(0, 1).equals("0")) {
//			phone_num = "0"+phone_num;
//		}
		
		try {
			
			String MobileNo = phone_num;
			String CharSet = "U";
			String SMSMessage = URLEncoder.encode("[巧遇]您的驗證碼是:" + code + ", 請於5分鐘內正確輸入", "UTF-8");
//	      String SMSMessage = System.Web.HttpUtility.UrlEncode( "[巧遇]您的驗證碼是:" + code + ", 請於30分鐘內正確輸入",Encoding.UTF8);
			String SourceProdID = "lailaitalk";
			String SourceMsgID = UUID.randomUUID().toString().replaceAll("-", "");
			
			Password = Md5Util.encodeByMD5(MemberID + ":" + Password + ":" + SourceProdID + ":" + SourceMsgID);

			String url = "http://www.yoyo8.com.tw/SMSBridge.php?" + "MemberID=" + MemberID + "&Password=" + Password
					+ "&MobileNo=" + MobileNo + "&CharSet=" + CharSet + "&SMSMessage=" + SMSMessage + "&SourceProdID="
					+ SourceProdID + "&SourceMsgID=" + SourceMsgID;

//			System.out.println(url);
			
			String resStr = HttpUtil.httpConnection(url);
//			String resStr = HttpUtil.httpConnection("http://www.yoyo8.com.tw/SMSBridge.php?MemberID=lailaitalk&Password=688fcb817b8567233068f8169fc64a74&MobileNo=0975133579&CharSet=U&SMSMessage=%5b%e4%be%86%e4%be%86%e8%81%8a%5d%e6%82%a8%e7%9a%84%e9%a9%97%e8%ad%89%e7%a2%bc%e6%98%af%3a5208%2c+%e8%ab%8b%e6%96%bc30%e5%88%86%e9%90%98%e5%85%a7%e6%ad%a3%e7%a2%ba%e8%bc%b8%e5%85%a5&SourceProdID=lailaitalk&SourceMsgID=10480");

			System.out.println(resStr);
			
			String str = resStr.substring(resStr.indexOf("retstr"));
			
			if(str.equals("retstr=Success")) {
				return true;
			}
	...
	public static void main(String[] args) {
		try {
//			sendInternationalSms("886980150819", "1234"); 
